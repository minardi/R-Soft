...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { activity: @table.activity, capacity: @table.capacity, orderid: @table.orderid, state: @table.state, waiter: @table.waiter }
    end
  ...
  test "should update table" do
    patch :update, id: @table, table: { activity: @table.activity, capacity: @table.capacity, orderid: @table.orderid, state: @table.state, waiter: @table.waiter }
    assert_redirected_to table_path(assigns(:table))
  end
